...
pub enum DataKey {
    ...
    /// patient_id → Vec<u64> (outcome ids) (#566)
    PatientOutcomes(Address),
    /// outcome_id → u64 (linked external care_plan_id) (#566)
...
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct OutcomePageResult {
    pub outcome_ids: Vec<u64>,
    pub has_more: bool,
}
